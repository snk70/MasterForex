...
Sub SetSizeViews(View As View,tv As Float,lv As Float,wv As Float,hv As Float,FontSize As Float)
sizemode(View,tv,lv,hv,wv,WidthAct,HeightAct)
End Sub

Sub SetSize_btn(View As Button,tv As Float,lv As Float,wv As Float,hv As Float,FontSize As Float)
sizemode(View,tv,lv,hv,wv,WidthAct,HeightAct)
View.TextSize=fsz(View.Width,View.Height,GetPastWidth(View.Width),GetPastHeight(View.Height),FontSize)
End Sub

Sub SetSize_Checkbox(View As CheckBox,tv As Float,lv As Float,wv As Float,hv As Float,FontSize As Float)
sizemode(View,tv,lv,hv,wv,WidthAct,HeightAct)
View.TextSize=fsz(View.Width,View.Height,GetPastWidth(View.Width),GetPastHeight(View.Height),FontSize)
End Sub

Sub SetSize_txt(View As EditText,tv As Float,lv As Float,wv As Float,hv As Float,FontSize As Float)
sizemode(View,tv,lv,hv,wv,WidthAct,HeightAct)
View.TextSize=fsz(View.Width,View.Height,GetPastWidth(View.Width),GetPastHeight(View.Height),FontSize)
End Sub

Sub SetSize_ScrolView(View As ScrollView,tv As Float,lv As Float,wv As Float,hv As Float,FontSize As Float)
sizemode(View,tv,lv,hv,wv,WidthAct,HeightAct)
End Sub

Sub SetSize_lbl_Views(View As Label,tv As Float,lv As Float,wv As Float,hv As Float,FontSize As Float)
sizemode(View,tv,lv,hv,wv,WidthAct,HeightAct)
View.TextSize=fsz(View.Width,View.Height,GetPastWidth(View.Width),GetPastHeight(View.Height),FontSize)
End Sub

Sub SetSize_img(View As ImageView,tv As Float,lv As Float,wv As Float,hv As Float,FontSize As Float)
sizemode(View,tv,lv,hv,wv,WidthAct,HeightAct)
End Sub
