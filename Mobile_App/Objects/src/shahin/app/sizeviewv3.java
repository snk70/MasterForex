...
public static float _vv6 = 0f;
public static float _vv7 = 0f;
...
public static int  _vvvv3(anywheresoftware.b4a.BA _ba,float _wdh,float _hgh,float _szw,float _szh,int _fs) throws Exception{
float _fs1 = 0f;
float _fs2 = 0f;
float _fs3 = 0f;
float _n1 = 0f;
float _n2 = 0f;
 //BA.debugLineNum = 74;BA.debugLine="Private Sub fsz(wdh As Float,hgh As Float,szw As F";
 //BA.debugLineNum = 75;BA.debugLine="Dim fs1,fs2,fs3 As Float";
_fs1 = 0f;
_fs2 = 0f;
_fs3 = 0f;
 //BA.debugLineNum = 76;BA.debugLine="Dim n1,n2 As Float";
_n1 = 0f;
_n2 = 0f;
 //BA.debugLineNum = 78;BA.debugLine="fs1=getinch(wdh)";
_fs1 = (float)(Double.parseDouble(_vv0(_ba,_wdh)));
 //BA.debugLineNum = 79;BA.debugLine="fs3=getinch(hgh)";
_fs3 = (float)(Double.parseDouble(_vv0(_ba,_hgh)));
 //BA.debugLineNum = 80;BA.debugLine="n1=fs1/szw";
_n1 = (float) (_fs1/(double)_szw);
 //BA.debugLineNum = 81;BA.debugLine="n2=fs3/szh";
_n2 = (float) (_fs3/(double)_szh);
 //BA.debugLineNum = 83;BA.debugLine="If n1>n2 Then";
if (_n1>_n2) { 
 //BA.debugLineNum = 84;BA.debugLine="fs2=n2*fs";
_fs2 = (float) (_n2*_fs);
 }else if(_n2>_n1) { 
 //BA.debugLineNum = 86;BA.debugLine="fs2=n1*fs";
_fs2 = (float) (_n1*_fs);
 }else if(_n1==_n2) { 
 //BA.debugLineNum = 88;BA.debugLine="fs2=n1*fs";
_fs2 = (float) (_n1*_fs);
 };
 //BA.debugLineNum = 91;BA.debugLine="Return fs2*1.5773684210526315789473684210526";
if (true) return (int) (_fs2*1.5773684210526315789473684210526);
 //BA.debugLineNum = 92;BA.debugLine="End Sub";
return 0;
}
public static String  _vv0(anywheresoftware.b4a.BA _ba,float _px) throws Exception{
 //BA.debugLineNum = 68;BA.debugLine="Sub getinch(px As Float)";
 //BA.debugLineNum = 69;BA.debugLine="Dim h As Float";
_vv3 = 0f;
 //BA.debugLineNum = 70;BA.debugLine="h=px/inc";
_vv3 = (float) (_px/(double)_v7);
 //BA.debugLineNum = 71;BA.debugLine="Return h";
if (true) return BA.NumberToString(_vv3);
 //BA.debugLineNum = 72;BA.debugLine="End Sub";
return "";
}
public static double  _vvvv4(anywheresoftware.b4a.BA _ba,float _px) throws Exception{
 //BA.debugLineNum = 114;BA.debugLine="Private Sub GetPastHeight(px As Float) As Double";
 //BA.debugLineNum = 116;BA.debugLine="Return (PastHeightScreen/getinch(HeightAct))*getin";
if (true) return (_vv7/(double)(double)(Double.parseDouble(_vv0(_ba,_vv5))))*(double)(Double.parseDouble(_vv0(_ba,_px)));
 //BA.debugLineNum = 117;BA.debugLine="End Sub";
return 0;
}
public static double  _vvvv5(anywheresoftware.b4a.BA _ba,float _px) throws Exception{
 //BA.debugLineNum = 109;BA.debugLine="Private Sub GetPastWidth(px As Float) As Double";
 //BA.debugLineNum = 111;BA.debugLine="Return (PastWidthScreen/getinch(WidthAct))*getinch";
if (true) return (_vv6/(double)(double)(Double.parseDouble(_vv0(_ba,_vv4))))*(double)(Double.parseDouble(_vv0(_ba,_px)));
...
public static String  _vvv1(anywheresoftware.b4a.BA _ba,float _wdt,float _hig) throws Exception{
...
public static String  _vvv2(anywheresoftware.b4a.BA _ba,float _wdt,float _hig,float _pastscreenwidth_px,float _pastscreenheight_px) throws Exception{
float _f1 = 0f;
float _f2 = 0f;
float _f3 = 0f;
float _vatar = 0f;
...
_vvvv6(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_view.getObject())),_tv,_lv,_hv,_wv,_vv4,_vv5);
 //BA.debugLineNum = 42;BA.debugLine="View.TextSize=fsz(View.Width,View.Height,GetPastWi";
_view.setTextSize((float) (_vvvv3(_ba,(float) (_view.getWidth()),(float) (_view.getHeight()),(float) (_vvvv5(_ba,(float) (_view.getWidth()))),(float) (_vvvv4(_ba,(float) (_view.getHeight()))),(int) (_fontsize))));
...
public static String  _setsize_img(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ImageViewWrapper _view,float _tv,float _lv,float _wv,float _hv,float _fontsize) throws Exception{
...
public static String  _setsize_lbl_views(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.LabelWrapper _view,float _tv,float _lv,float _wv,float _hv,float _fontsize) throws Exception{
...
public static String  _setsize_scrolview(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ScrollViewWrapper _view,float _tv,float _lv,float _wv,float _hv,float _fontsize) throws Exception{
...
public static String  _vvv3(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _view,float _tv,float _lv,float _wv,float _hv,float _fontsize) throws Exception{
...
_vvvv6(_ba,_view,_tv,_lv,_hv,_wv,_vv4,_vv5);
 //BA.debugLineNum = 38;BA.debugLine="End Sub";
return "";
}
public static String  _vvvv6(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _view,float _tv,float _lv,float _hv,float _wv,float _xv,float _yv) throws Exception{
 //BA.debugLineNum = 96;BA.debugLine="Private Sub sizemode(View As View,tv As Float,lv A";
 //BA.debugLineNum = 97;BA.debugLine="View.Top=tv*(yv/DV_Height)";
_view.setTop((int) (_tv*(_yv/(double)_dv_height)));
 //BA.debugLineNum = 98;BA.debugLine="View.Left=lv*(xv/DV_Width)";
_view.setLeft((int) (_lv*(_xv/(double)_dv_width)));
 //BA.debugLineNum = 99;BA.debugLine="View.Width=wv*(xv/DV_Width)";
_view.setWidth((int) (_wv*(_xv/(double)_dv_width)));
 //BA.debugLineNum = 100;BA.debugLine="View.Height=hv*(yv/DV_Height)";
_view.setHeight((int) (_hv*(_yv/(double)_dv_height)));
 //BA.debugLineNum = 102;BA.debugLine="t=View.Top";
_v0 = (float) (_view.getTop());
 //BA.debugLineNum = 103;BA.debugLine="l=View.Left";
_vv1 = (float) (_view.getLeft());
 //BA.debugLineNum = 104;BA.debugLine="w=View.Width";
_vv2 = (float) (_view.getWidth());
 //BA.debugLineNum = 105;BA.debugLine="h=View.Height";
_vv3 = (float) (_view.getHeight());
